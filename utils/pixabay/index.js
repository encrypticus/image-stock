 ...
 * @throws {BadResponse}
 */
const searchImagesReq = function (key, query, options, validate) {
  if (options === void 0) { options = {}; }
  if (validate === void 0) { validate = true; }
  return __awaiter(_this, void 0, void 0, function () {
    let requestData; let response; let
      responseData;
    return __generator(this, (_a) => {
      switch (_a.label) {
        case 0:
          requestData = { ...options, key, q: query };
          if (validate) {
 ...
 * @throws {BadResponse}
 */
const searchVideosReq = function (key, query, options, validate) {
  if (options === void 0) { options = {}; }
  if (validate === void 0) { validate = true; }
  return __awaiter(_this, void 0, void 0, function () {
    let requestData; let
...
exports.authenticate = function (key) {
  return ({
     ...
     * @throws {BadResponse}
     */
    searchImages(query, options, validate) {
      if (options === void 0) { options = {}; }
      if (validate === void 0) { validate = true; }
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, (_a) => {
     ...
     * @throws {BadResponse}
     */
    searchVideos(query, options, validate) {
      if (options === void 0) { options = {}; }
      if (validate === void 0) { validate = true; }
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, (_a) => {
